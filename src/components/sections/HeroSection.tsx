    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-hero overflow-hidden px-4 py-20">
      ...
      <div className="container mx-auto max-w-5xl relative z-10 text-center">
        ...
        <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-2 mb-6 animate-fade-in">
          ...
          <span className="text-sm font-medium text-primary"><span className="text-sm font-medium text-primary"><span className="text-sm font-medium text-primary"><span className="text-sm font-medium text-primary">Sábado, 14/03</span></span></span></span>
